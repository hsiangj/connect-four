...
function makeHtmlBoard() {
  ...
  //create table row that is clickable (for game pieces to be dropped)
...
function checkForWin() {
  ...
  //setting variables for possible ways to win with 4 cells 
  for (let y = 0; y < HEIGHT; y++) {
    for (let x = 0; x < WIDTH; x++) {
      ...
      //checks to see if any of the winning combination is true/filled by the same player
